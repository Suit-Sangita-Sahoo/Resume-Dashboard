...
const Home = () => {
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="mt-24 px-10">
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-12">
          ...
          <div className="bg-white p-6 rounded-2xl shadow hover:shadow-lg transition">
            ...
            <p className="mt-3 text-gray-600">
              Identify your strengths and missing skills for your dream job.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-2xl shadow hover:shadow-lg transition">
            ...
            <p className="mt-3 text-gray-600">
              Get job recommendations based on your resume and skills.
            </p>
          </div>
      ...
      {/* 🔹 Footer */}
      <div className="mt-20 bg-blue-700 text-white text-center py-4">
        <p>© 2026 ResumeAnalyzer | Built with ❤️ using React</p>
      </div>
